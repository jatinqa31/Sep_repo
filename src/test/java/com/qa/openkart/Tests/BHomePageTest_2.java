...
public class BHomePageTest_2 extends base_class{
...
//    Homepage homepage = new Homepage(page);
		...
		@Test(priority =3,description ="Get Title of Home Page") 
		public void Operations_2() { 
			homepage = new Homepage(page);
			System.out.println("Title of Home page "+ homepage.getHomePageTitle());
		}
 
		@Test(priority =4, description ="Click on Leads Link on Home Page")
